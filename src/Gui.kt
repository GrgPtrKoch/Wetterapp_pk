...
/*    fun setFavoriteIcon() {
 ...
 /*   private val btnSetFavorite = Button().apply {
    ...
    private val onHomeClick = { location: Location ->
        ...
        tflSucheingabe.text = location.getLocationName()
 }


 private val btnAddFavorite = favorites.createAddButton(
     activeLocation = {selectedLocation},
     activeWeather = {selectedLocationWeather}
 )

    private val locationHbox = HBox().apply {
        alignment = Pos.CENTER_LEFT
        spacing = 8.0
        children.addAll(lblLocation,btnAddFavorite)
    }
    ...
    private val hBoxDayViewFavorites = HBox().apply {
       ...
       // vBoxFavorites.prefWidthProperty().bind(this.widthProperty().multiply(0.5))
        ...
        children.addAll(hBoxDayView,favBox)
    }
    ...
    private fun fillInWeatherData(weather: Weather?) {
        ...
        favorites.updateStarColor(selectedLocation)
