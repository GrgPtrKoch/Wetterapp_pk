/*
  ...
  Beschreibung: In Details View wird das Feld unten Links erstellt und mit den aktuellen Wetterdaten gefuellt.
 */
...
object detailsView {
    ...
    val vBoxWindDirection = VBox().apply {
        alignment = Pos.CENTER_RIGHT
        spacing = 5.0
        VBox.setMargin(windImageView, Insets(0.0, 5.0, 0.0, 0.0))
