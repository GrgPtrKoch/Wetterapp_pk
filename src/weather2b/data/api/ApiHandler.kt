...
// Werte aus "current"-Objekt extrahieren:
                ...
                val weatherCode = WeatherCodes.Companion.fromCode(weatherCodeInt,simpleDailyWeather)
                    ...
                    for (i in 0 until hourlyTimes.length()) {
                        ...
                        hourlyList.add(
                            HourlyWeather(
                                ...
                                apparentTemperature2M = hourlyObj.optJSONArray("apparent_temperature")?.optDouble(i)
                                    ?: 0.0,
                                ...
                                weatherCode = WeatherCodes.Companion.fromCode(hourlyWeatherCode, simpleDailyWeather),
                ...
                if (dailyTimes != null) {
                    ...
                    dailyList.add(
                        DailyWeather(
                            ...
                            apparentTemperatureMin = dailyObj.optJSONArray("apparent_temperature_min")?.optDouble(i)
                                ?: 0.0,
                            apparentTemperatureMax = dailyObj.optJSONArray("apparent_temperature_max")?.optDouble(i)
                                ?: 0.0,
                            ...
                            weatherCode = WeatherCodes.Companion.fromCode(dailyWeatherCode, simpleDailyWeather)
                        )
                    )
                    }
                }
